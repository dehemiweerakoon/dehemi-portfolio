  ...
  return (
    <>
      <div className="h-auto " id="projects">
        <div className="flex flex-row justify-center text-2xl mt-5 font-medium  ">
          <div className="bg-gradient-to-t from-indigo-400 to-pink-400 p-[2px] rounded-lg transform transition-all duration-300 animate-bounce ">
            <div className="bg-black rounded-lg">
               <h1 className="px-8 py-2 text-pink-300">Projects</h1>
            </div>
