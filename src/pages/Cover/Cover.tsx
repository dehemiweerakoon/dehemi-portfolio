    ...
    <>
      <section className="relative flex flex-col items-center justify-between py-4 lg:py-12">
        <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-50 gap-y-8 lg:mx-10">
          <div className="order-2 lg:order-2 border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r bg-white/20 backdrop-grayscale-4">
            ...
            <div className="overflow-hidden border-t-[2px] border-purple-900 px-4 lg:px-8 py-4 lg:py-8">
              <code className="font-mono text-xs md:text-sm lg:text-base">
                ...
                <div>
                  ...
                  <span className="text-gray-400">'</span>
                  <span className="text-cyan-200">Dehemi Weerakoon</span>
                  <span className="text-gray-400">',</span>
                </div>
                ...
                <div>
                  <span className="ml-24 text-cyan-400">this.</span>
                  <span className="text-white">TimeWorker</span>
                </div>
                <div>
          ...
          <div className="order-1 lg:order-2 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
            ...
            <div className="my-12 flex flex-row items-center gap-5 justify-center ">
              <Link
